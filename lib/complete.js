...
//
complete.init = function(options) {
  complete.callback = options.callback || complete.callback;
  complete.program = options.program || complete.program;
  complete.list = options.list || complete.list;
  ensure(complete.program || getName());
